  ...
  return (
    <div>
      <h2 id="meeting-heading" data-cy="MeetingHeading">
        <Translate contentKey="crmApp.meeting.home.title">Meetings</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="crmApp.meeting.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/meeting/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="crmApp.meeting.home.createLabel">Create new Meeting</Translate>
          </Link>
        </div>
      </h2>
        ...
        {meetingList && meetingList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="crmApp.meeting.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="crmApp.meeting.title">Title</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('title')} />
                </th>
                <th className="hand" onClick={sort('from')}>
                  <Translate contentKey="crmApp.meeting.from">From</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('from')} />
                </th>
                <th className="hand" onClick={sort('to')}>
                  <Translate contentKey="crmApp.meeting.to">To</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('to')} />
                </th>
                <th className="hand" onClick={sort('realated_to')}>
                  <Translate contentKey="crmApp.meeting.realated_to">Realated To</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('realated_to')} />
                </th>
                ...
                <th className="hand" onClick={sort('host')}>
                  <Translate contentKey="crmApp.meeting.host">Host</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('host')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="crmApp.meeting.home.notFound">No Meetings found</Translate>
            </div>
          )
        )}
      </div>
