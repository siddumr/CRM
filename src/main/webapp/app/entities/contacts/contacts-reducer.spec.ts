...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './contacts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONTACTS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONTACTS actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_CONTACTS actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTS actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CONTACTS actions', async () => {
      const arg = 42666;
