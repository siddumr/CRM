...
export const createEntity = createAsyncThunk(
  ...
  async (entity: ILead, thunkAPI) => {
    const result = await axios.post<ILead>(apiUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  'lead/update_entity',
  async (entity: ILead, thunkAPI) => {
    const result = await axios.put<ILead>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: ILead, thunkAPI) => {
    const result = await axios.patch<ILead>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<ILead>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
